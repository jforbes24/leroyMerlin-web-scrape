...
url = 'https://www.leroymerlin.fr/produits/electricite-domotique/alarme-camera-de-surveillance-et-detecteur-de-fumee/camera-de-surveillance/'
request_type = "get"
...
try:
    for link in range(1,2): #productLinks
        ...
        # result = requests.get(test, headers=headers, proxies=proxy)
